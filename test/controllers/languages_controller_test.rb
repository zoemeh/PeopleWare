...
class LanguagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create language" do
    assert_difference("Language.count") do
      post languages_url, params: { language: { code: @language.code, name: @language.name, status: @language.status } }
    end
  ...
  test "should update language" do
    patch language_url(@language), params: { language: { code: @language.code, name: @language.name, status: @language.status } }
