...
class TrainingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create training" do
    assert_difference("Training.count") do
      post trainings_url, params: { training: { description: @training.description, from_at: @training.from_at, institution: @training.institution, level: @training.level, to_at: @training.to_at } }
    end
  ...
  test "should update training" do
    patch training_url(@training), params: { training: { description: @training.description, from_at: @training.from_at, institution: @training.institution, level: @training.level, to_at: @training.to_at } }
